...
cd /home/parallel/parlab10/lab5/kmeans
...
for size in $sizes; do
	for coord in $coordinates; do
		for center in $centers; do
			...
			echo "Implementation,blockSize,av_loop_t,min_loop_t,max_loop_t,av_loop_gpu_t,av_loop_cpu_t,av_loop_gpu_cpu_t,av_loop_cpu_gpu_t" >> $filename
